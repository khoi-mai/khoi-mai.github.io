...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (savedTheme) {
      setIsDark(savedTheme === "customDark"); // check for custom theme
      ...
      document.documentElement.setAttribute(
        "data-theme",
        prefersDark ? "customDark" : "light" // default to customDark
      );
    }
  }, []);

  const handleThemeChange = (checked) => {
    const newTheme = checked ? "customDark" : "light"; // <-- use customDark here
    setIsDark(checked);
