...
export default function Navbar() {
  ...
  // Correctly load saved theme or system preference
  useEffect(() => {
    const savedTheme = localStorage.getItem("theme");
    if (savedTheme) {
      // Check for customDark instead of just 'dark'
      setIsDark(savedTheme === "customDark");
      ...
      document.documentElement.setAttribute(
        "data-theme",
        prefersDark ? "customDark" : "light"
      );
      localStorage.setItem("theme", prefersDark ? "customDark" : "light");
    }
  }, []);

  // Switch theme when toggle changes
  const handleThemeChange = (checked) => {
    const newTheme = checked ? "customDark" : "light";
    setIsDark(checked);
          ...
          <div className="flex items-center sm:gap-8 gap-5">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <li>
                  <Link href="/compositing" className="hover:underline">
                    Compositing
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/rigging" className="hover:underline">
                    Rigging
                  </Link>
                </li>
                <li>
